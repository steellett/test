window.onload = function() {
    ...
    document.querySelectorAll('[data-tip]').forEach(element => {
        element.onfocus = function() {
            ...
            tip.style.cssText = `display: flex; width: ${coords.width}px; position: absolute; right: 0; top: 0; transform: translateY(-100%); height: 1.2em; background: gray; align-self: center; border-radius: 0.5em; align-self: center; color: white; font-size: 1.5em; transition: all 1s ease;`;
